...
if (!isDedicated) then {
	...
	fnc_usec_damageActions =		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	fnc_inAngleSector =				compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_inAngleSector.sqf";		//Checks which actions for nearby casualty
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\fn_selfActions.sqf";		//Checks which actions for self
	...
	dayz_spaceInterrupt =			compile preprocessFileLineNumbers "FEAR\Snap_Pro\dayz_spaceInterrupt.sqf";
	...
	player_packTent =				compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\player_packTent.sqf";
	player_packVault =				compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\player_packVault.sqf";
	player_unlockVault =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\player_unlockVault.sqf";
	...
	player_lockVault =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\player_lockVault.sqf";
	player_updateGui =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\player_updateGui.sqf";
	...
	player_tentPitch =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\tent_pitch.sqf";
	player_vaultPitch =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\vault_pitch.sqf";
	...
	player_build =				compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\modular_build.sqf";
	player_build_countNearby =	compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_countNearby.sqf";
	player_build_states =		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_states.sqf";
	player_build_needNearby =	compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_needNearby.sqf";
	player_build_getConfig =	compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_getConfig.sqf";
	player_build_plotCheck =	compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_plotCheck.sqf";
	player_build_buildReq =		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_buildReq.sqf";
	player_build_create =		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_create.sqf";
	player_build_controls =		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_controls.sqf";
	player_build_publish =		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\player_build_publish.sqf";
	DZE_snap_build_file = 		"FEAR\Snap_Pro\snap_build.sqf"; // Set as a global variable as it is also referenced in snapbuild.sqf
	snap_build = 				compile preprocessFileLineNumbers DZE_snap_build_file;
	
	FNC_check_owner =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\fn_check_owner.sqf";
	FNC_find_plots =			compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Compile\fn_find_plots.sqf";
	...
	player_plotPreview = 		compile preprocessFileLineNumbers "FEAR\A_Plot_for_Life\Action\object_showPlotRadius.sqf";
