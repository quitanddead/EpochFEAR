...
if !(isServer && isDedicated) then
{
	...
	R3F_LOG_FNCT_objet_init = compile preprocessFile "FEAR\R3F_ARTY_AND_LOG\R3F_LOG\objet_init.sqf";
	R3F_LOG_FNCT_heliporteur_init = compile preprocessFile "FEAR\R3F_ARTY_AND_LOG\R3F_LOG\heliporteur\heliporteur_init.sqf";
	R3F_LOG_FNCT_remorqueur_init = compile preprocessFile "FEAR\R3F_ARTY_AND_LOG\R3F_LOG\remorqueur\remorqueur_init.sqf";
	R3F_LOG_FNCT_transporteur_init = compile preprocessFile "FEAR\R3F_ARTY_AND_LOG\R3F_LOG\transporteur\transporteur_init.sqf";
	...
	execVM "FEAR\R3F_ARTY_AND_LOG\R3F_LOG\surveiller_conditions_actions_menu.sqf";
};