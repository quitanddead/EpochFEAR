...
[] spawn
{
	...
	call compile preprocessFile format ["FEAR\R3F_ARTY_AND_LOG\%1_strings_lang.sqf", R3F_ARTY_AND_LOG_CFG_langage];
	...
	{
		execVM "FEAR\R3F_ARTY_AND_LOG\surveiller_nouveaux_objets.sqf";
	}
	// Version allégée pour le serveur dédié
	else
	{
		execVM "FEAR\R3F_ARTY_AND_LOG\surveiller_nouveaux_objets_dedie.sqf";
	};
};
