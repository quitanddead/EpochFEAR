...
// general settings
_folder = "FEAR\service_point\"; // folder where the service point scripts are saved, relative to the mission file
_servicePointClasses = ["Land_A_FuelStation_Feed", "Land_A_FuelStation_Feed", "Land_Ind_TankSmall", "Land_Ind_TankSmall2", "Land_Ind_TankSmall2_EP1", "Land_fuel_tank_stairs", "Land_fuel_tank_small", "FuelPump_DZ"]; // service point classes (add "FuelPump_DZ" to use the dynamic Epoch fuel pumps) (can be house, vehicle and unit classes)
