...
call compile preprocessFileLineNumbers "FEAR\trade_from_vehicle\system\functions.sqf";
call compile preprocessFileLineNumbers "FEAR\trade_from_vehicle\system\variables.sqf";

sleep 0.5;

ExecVM "FEAR\trade_from_vehicle\monitor.sqf";