...
[leader _grp,_patrolMarker,"random","nofollow","nowait","noslow"] execVM "\z\addons\dayz_server\FEAR\dynamic_ups\UPS.sqf";

// Debug: track unit
//[leader _grp,"WP","GROUP","SHOWSTATIC"] execVM "FEAR\dynamic_ups\track.sqf";
